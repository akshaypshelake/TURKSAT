...
public class HttpSystemApi {
		...
		public void PCRF_SubStatusQuery(){
		   ...
		   given()
		   .when()
		   .get("http://10.70.90.72/cgi-bin/ssSystemApi?command=QUERY&message=substatus," + MSISDN)
		   .then()
		   .statusCode(200)
		   .and()
		   .log()
		...
		public void PCRF_PackBalanceQuery(){
		   ...
		   given()
		   .when()
		   .get("http://10.70.90.72/cgi-bin/ssSystemApi?command=QUERY&message=packbalance," + MSISDN + "," + RATEPLAN)
		   .then()
		   .statusCode(200)
		   .and()
		   .log()
		...
		public void PCRF_PackUsageQuery(){
			Response response =
		     given()
		    .when()
		    .get("http://10.70.90.72/cgi-bin/ssSystemApi?command=QUERY&message=packusage," + MSISDN + "," + RATEPLAN)
		    .then()
		    .statusCode(200)
		    .and()
			.log()
